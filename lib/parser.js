...
exports.encodePackets = function(packets) {
  if (!Array.isArray(packets)) {
    return exports.encodePacket(packets);
  }

  var encodedPackets = [];
  packets.forEach(function(packet) {
    encodedPackets.push(exports.encodePacket(packet));
  });

  return exports.encodePayload(encodedPackets);
};
