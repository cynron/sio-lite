...
Memory.prototype.destroyById = function(id) {
 ...
 *
 * @param {String} id sessionid
 * @param {Number} timeout second to wait 
 * @param {Function} cb  call back 
 * @api public
 */

Memory.prototype.getFromRecvQ = function(id, timeout, cb) {
  var self = this;
...
Memory.prototype.getFromSendQ = function(id, timeout, cb) {
  var self = this;
 ...
 *
 * @param {String} id  sessionid
 * @param {Array|Object} msgs  messages to be pushed
